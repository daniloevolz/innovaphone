                                                ...
                                                .oncomplete(function (data) {
                                                    ...
                                                    try {
                                                        ...
                                                        var dataClient = "<!DOCTYPE html>"
                                                            ...
                                                            + "</td>"
                                                            + "<td style= 'background-color: #1a73e8;border: none; width: 25%; color:white ;padding:15px;border-radius: 5px; display:flex; justify-content: center; align-items: center; text-align: center;' onclick='window.location='http://example.com''>"
