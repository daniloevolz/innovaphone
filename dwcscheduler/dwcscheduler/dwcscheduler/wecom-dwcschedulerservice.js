                                                ...
                                                .oncomplete(function (data) {
                                                    ...
                                                    try {
                                                        ...
                                                        var dataClient = "<!DOCTYPE html>"
                                                            ...
                                                            + "<head></head>"
                                                            + "<body>"
                                                            + "<div class ='main-body' style = 'border: solid 1px #dadce0; height: 150px; border-radius: 8px; flex-direction: row-reverse; display:flex;'>"
                                                            + "<div class ='btn-url-inn' style = ' background-color: #1a73e8;padding: 10px 25px;border: none;border-radius: 5px; display:flex; width: 15%; margin-top: 25px;aligns-items:center; margin-left: 25px; height: 50px; text-align:center; justify-content: center; float:right'> "
                                                            + "<span style = 'font-size: 18px; color:white; font-weight: bold; text-align: center; align-items: center; display: flex; justify-content:center;' >"
                                                            + "Entrar na Reunião"
                                                            + "</span>"
                                                            + "</div>"
                                                            + "<br>"
                                                            // + "<h3>" + cfg[0].text_invite + "</h3><br/>"
                                                           //  + "<b>URL do Evento:</b> " + cfg[0].url_conference +"<br/>"
                                                            + "<div id='when' style = 'margin-top: 25px; margin-left: 50%'>"
                                                            + "<b>Quando:</b> " + "<br>" + day + "&nbsp;" + time +"<br/>"
                                                            + "</div>"
                                                            + "<br>"
                                                            + "<div id ='url' style = 'margin-top: 25px; margin-left: 0%; '>"
                                                            + "<b>Link da Reunião</b>" + "<br>" + cfg[0].url_conference + "<br/>"
                                                            + "</div>"
