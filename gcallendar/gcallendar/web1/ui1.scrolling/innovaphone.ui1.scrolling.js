...
innovaphone.ui1.Scrolling = innovaphone.ui1.Scrolling || function (style, mx, my, width, color, cstyle, cl) {
    ...
    if (navigator.platform.startsWith("Win") && !innovaphone.ui1.lib.browser.webkit && innovaphone.ui1.lib.browser.name != "Firefox") {
        ...
        this.isScrollTop = function (distance) { return (inner.container.scrollTop <= (distance ? distance : 0)); };
        ...
        this.isScrollTop = function (distance) { return (this.container.scrollTop <= (distance ? distance : 0)); };
