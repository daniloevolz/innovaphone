                                ...
                                if (s.type == "periodType") {
                                    if (selectstart >= s.data_start.split("T")[0] && selectstart <= s.data_end.split("T")[0]) {
                                        if (s.schedule_module == "hourModule") {
                                            ...
                                            // clickedDateEndMoment.subtract(1, 'days'); passar para formato Moment dia 7/12 
                                            // period esta contando um dia para frente , fazer o mesmo que foi feito no recorrente para ca 
                                            // ~pietro 
