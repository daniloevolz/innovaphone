...
function formatDate(inputDate) {
    ...
    function makeDivCreateRoom(t){
        ...
        var selectTypeRoom = divGeral.add(new innovaphone.ui1.Node("select",null,null,null))
        selectTypeRoom.add(new innovaphone.ui1.Node("option","height:50px","Recorrente",null))
