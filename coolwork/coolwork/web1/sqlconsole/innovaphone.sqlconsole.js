...
innovaphone.SqlConsole = innovaphone.SqlConsole || function (style, app) {
    ...
    var ctrl = false;
    var input = panel.add(new innovaphone.ui1.Node("textarea", "position:relative; box-sizing:border-box; width:100% height:150px; flex-grow:10; resize:none")).addEvent("keydown", function (e) {
